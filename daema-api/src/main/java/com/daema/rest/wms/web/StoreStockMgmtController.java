...
public class StoreStockMgmtController {
    ...
    public ResponseEntity<CommonResponse<ResponseDto<StoreStockResponseDto>>> getStoreStockList(StoreStockRequestDto requestDto) {
        return responseHandler.getResponseMessageAsRetrieveResult(storeStockMgmtService.getStoreStockList(requestDto, WmsEnum.StoreStockPathType.STORE_STOCK), ResponseCodeEnum.NODATA.getResultCode(), ResponseCodeEnum.NODATA.getResultMsg());
    }
    ...
    public ResponseEntity<CommonResponse<ResponseDto<StoreStockResponseDto>>> getLongTimeStoreStockList(StoreStockRequestDto requestDto) {
        return responseHandler.getResponseMessageAsRetrieveResult(storeStockMgmtService.getStoreStockList(requestDto, WmsEnum.StoreStockPathType.LONG_TIME_STORE_STOCK), ResponseCodeEnum.NODATA.getResultCode(), ResponseCodeEnum.NODATA.getResultMsg());
    }
    ...
    public ResponseEntity<CommonResponse<ResponseDto<StoreStockResponseDto>>> getFaultyStoreStockList(StoreStockRequestDto requestDto) {
        return responseHandler.getResponseMessageAsRetrieveResult(storeStockMgmtService.getStoreStockList(requestDto, WmsEnum.StoreStockPathType.FAULTY_STORE_STOCK), ResponseCodeEnum.NODATA.getResultCode(), ResponseCodeEnum.NODATA.getResultMsg());
    }

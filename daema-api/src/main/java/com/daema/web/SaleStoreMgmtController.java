...
public class SaleStoreMgmtController {
    ...
    @ApiOperation(value = "영업점 등록", notes = "신규 영업점을 등록합니다", nickname = Constants.API_SALE_STORE + "||2")
    ...
    @ApiOperation(value = "영업점 수정", notes = "영업점의 내용을 변경합니다", nickname = Constants.API_SALE_STORE + "||3")
    ...
    @ApiOperation(value = "영업점 삭제", notes = "관리점과 영업점과의 맵핑을 제거합니다", nickname = Constants.API_SALE_STORE + "||4")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "영업점 사용여부 수정", notes = "영업점의 사용 여부를 변경합니다", nickname = Constants.API_SALE_STORE + "||5")
    @ApiImplicitParams({

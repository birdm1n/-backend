...
public class SaleStoreMgmtController {
    ...
    public ResponseEntity<CommonResponse<Void>> insertStore(@ApiParam(value = "영업점 정보", required = true)
    ...
    public ResponseEntity<CommonResponse<Void>> deleteStore(@ApiParam(value = "영업점 ID", required = true) @RequestBody String id) {
    ...
    public ResponseEntity<CommonResponse<Void>> updateStoreUse(@ApiParam(value = "영업점 ID", required = true) @RequestBody SaleStoreMgmtDto saleStoreMgmtDto) {

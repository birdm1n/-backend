...
public class BoardController {
    ...
    @GetMapping("")
    public ResponseEntity<CommonResponseMessage<BoardResponseDto>> getBoardList(BoardRequestDto requestDto) {
        try{
            // 단순 응답
    ...
    @PostMapping("")
    public ResponseEntity<CommonResponseMessage<Void>> insertBoard(@ApiParam(value = "게시판 domain", required = true) @RequestBody BoardDto boardDto) {
        try {
            // 단순 응답
    ...
    @PatchMapping("")
    public ResponseEntity<CommonResponseMessage<Void>> updateBoard(@ApiParam(value = "게시판 domain", required = true) @RequestBody BoardDto boardDto) {
    ...
    @GetMapping("/{boardNo}")
    public ResponseEntity<CommonResponseMessage<BoardDto>> getBoardDetail(@ApiParam(value = "게시글 번호", required = true) @PathVariable(value = "boardNo") String boardNo) {
        try{
    ...
    public ResponseEntity<CommonResponseMessage<Void>> deleteBoard(@ApiParam(value = "게시글 번호", required = true) @PathVariable(value = "boardNo") String boardNo) {
